/* CREATE library_db_apeilk_pub_type TYPE */
CREATE OR REPLACE TYPE library_db_apeilk_pub_type UNDER library_db_apeilk_person_type
(
	...
	MEMBER PROCEDURE get_(id_   IN NUMBER,
												data_ OUT library_db_apeilk_pub_type),
